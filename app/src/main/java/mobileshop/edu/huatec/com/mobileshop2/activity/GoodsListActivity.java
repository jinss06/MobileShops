...
import mobileshop.edu.huatec.com.mobileshop2.adapter.GoodsListAdapter;
...
import mobileshop.edu.huatec.com.mobileshop2.http.presenter.GoodsPresenter;
...
public class GoodsListActivity extends BaseActivity {
    ...
    SwipeRefreshLayout goodslistSwiperRefresh;
    ...
    protected void initView() {
        ...
        //设置刷新样式
        goodslistSwiperRefresh.setColorSchemeResources(
        ...
        //下拉刷新监听器
        goodslistSwiperRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
    ...
    private void loadData() {
        GoodsPresenter.list(new Subscriber<List<GoodsEntity>>() {
            ...
            public void onCompleted() {
                goodslistSwiperRefresh.setRefreshing(false);
            }
